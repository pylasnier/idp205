...
#define     DIVISION_MEAN_WEIGHTING     0.03    // How much each division contributes to mean
// (about 24 divisions will comprise 50% of the mean. At around 9 rpm, this damps oscillations due to variance in division size by 90%.)

#define     CHANGE_FOR_MEAN_RESET       0.2     // Ratio
#define     SPEED_CALIBRATION_THRESHOLD 0.03    // m/s

#define     INITIAL_CONVERSION_VALUE    69000
